...
const generateRandomCardImage = () => allCards[Math.floor(Math.random() * (allCards.length - 1))] //generates random card images

//set up random cards for both players
...
const Card = ({ card, title, restStyles, cardRef, playerTwo }) => {
  return (
    ...
    <div className={`${styles.cardContainer} ${restStyles}`}>
      ...
      <div className={`${styles.cardPointContainer} left-[22%] sm:left-[21.2%] ${styles.flexCenter}`}>
